...
__bundle_register("src.classes.engineer", function(require, _LOADED, __bundle_register, __bundle_modules)
local engineer = {}
...
__bundle_register("src.classes.spy", function(require, _LOADED, __bundle_register, __bundle_modules)
local spy = {}
...
__bundle_register("src.classes.pyro", function(require, _LOADED, __bundle_register, __bundle_modules)
local pyro = {}
...
__bundle_register("src.classes.heavy", function(require, _LOADED, __bundle_register, __bundle_modules)
local heavy = {}
...
__bundle_register("src.classes.medic", function(require, _LOADED, __bundle_register, __bundle_modules)
local medic = {}
...
__bundle_register("src.classes.demoman", function(require, _LOADED, __bundle_register, __bundle_modules)
local demo = {}
...
__bundle_register("src.classes.soldier", function(require, _LOADED, __bundle_register, __bundle_modules)
local soldier = {}
...
__bundle_register("src.classes.sniper", function(require, _LOADED, __bundle_register, __bundle_modules)
local sniper = {}
...
__bundle_register("src.classes.scout", function(require, _LOADED, __bundle_register, __bundle_modules)
local scout = {}
...
__bundle_register("src.panel", function(require, _LOADED, __bundle_register, __bundle_modules)
local panel = {}
...
__bundle_register("src.classes.generic", function(require, _LOADED, __bundle_register, __bundle_modules)
local generic = {}
...
__bundle_register("src.chat", function(require, _LOADED, __bundle_register, __bundle_modules)
local chat = {}
local messages = {}
...
function chat:Run(utils)
	...
	utils.DrawText(nil, x + (width // 2) - (text_w // 2), y - (25 // 2) - (text_h // 2), "chat")
	...
	for i, msg in pairs(messages) do
		...
		if playerlist.GetPriority(msg.player) > 0 then
			...
			local height_used = utils.DrawColoredText(x + 3, start_y, full_msg, width - 6, true)
...
__bundle_register("src.spectate", function(require, _LOADED, __bundle_register, __bundle_modules)
local spectate = {}
